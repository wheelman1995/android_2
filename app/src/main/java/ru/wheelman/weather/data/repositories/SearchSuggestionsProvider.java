...
import ru.wheelman.weather.di.modules.SearchSuggestionsProviderModule;
import ru.wheelman.weather.di.scopes.ApplicationScope;
import toothpick.Scope;
import toothpick.Toothpick;

public class SearchSuggestionsProvider extends ContentProvider implements ISearchSuggestionsProvider {
    ...
    //        return ourInstance;
    //    }
    private static final int CURRENT_LOCATION_SUGGESTION_ID = 0;
    //    public static final String CURRENT_LOCATION_SUGGESTION_INTENT_DATA = "current_location_suggestion_id";
    private static final String CURRENT_LOCATION_SUGGESTION_COLUMN_TEXT_1 = "Use your location";
    private static final String TAG = SearchSuggestionsProvider.class.getSimpleName();
    @Inject
    SQLiteDatabase db;
    private boolean currentLocationSuggestionEnabled;
    private String proj;
    ...
    private void initToothpick() {
        Scope scope = Toothpick.openScope(ApplicationScope.class);
        scope.installModules(new SearchSuggestionsProviderModule(this, getContext()));
...
//        }
    ...
    @Override
    public void setLocationFeatures(boolean enabled) {
        currentLocationSuggestionEnabled = enabled;
    }

    @Override
    public boolean useYourLocationWasSelected(int cityId) {
        return cityId == CURRENT_LOCATION_SUGGESTION_ID;
    }
}
